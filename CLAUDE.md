...
**YOU ARE IN: `user_api/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/user_api/` (rig root) or other directories
...
**Your mail address:** `user_api/polecats/furiosa`
**Your rig:** user_api
**Your Witness:** `user_api/witness`
...
| Ask Witness for help | `gt mail send user_api/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`user_api/witness`) when:
...
```bash
gt mail send user_api/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
